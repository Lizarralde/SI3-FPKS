...
public class TargetObjectView implements GameObjectView {
    ...
    static{
        ...
        String[] filePaths = {RES_IMG + "/target1.png", RES_IMG + "/target2.png", RES_IMG + "/target3.png", RES_IMG + "/target4.png"};
        ...
        hitPathsArray.add(new String[]{RES_IMG + "/hitanim1_1.png", RES_IMG + "/hitanim1_2.png", RES_IMG + "/hitanim1_3.png", RES_IMG + "/hitanim1_4.png"});
        hitPathsArray.add(new String[]{RES_IMG + "/hitanim2_1.png", RES_IMG + "/hitanim2_2.png", RES_IMG + "/hitanim2_3.png", RES_IMG + "/hitanim2_4.png"});
        hitPathsArray.add(new String[]{RES_IMG + "/hitanim3_1.png", RES_IMG + "/hitanim3_2.png", RES_IMG + "/hitanim3_3.png", RES_IMG + "/hitanim3_4.png"});
        hitPathsArray.add(new String[]{RES_IMG + "/hitanim4_1.png", RES_IMG + "/hitanim4_2.png", RES_IMG + "/hitanim4_3.png", RES_IMG + "/hitanim4_4.png"});
