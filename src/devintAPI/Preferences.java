...
public class Preferences {
	...
	/** liste des classes (i.e. fenétres) qui vont utiliser ces préférences
	 ...
	 * on passe d'un jeu prédéfini é un autre
	 */
	public void changeColor() {
		...
		// on met é jour toutes les menus avec ce nouveau jeu de couleurs
	...
	// pour changer la voix en passant é la suivante
	...
	// pour ajouter une fenétre é la liste des fenétres dont on peut fixer les préférences
